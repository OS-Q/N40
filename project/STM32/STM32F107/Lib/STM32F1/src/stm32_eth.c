...
uint32_t ETH_Init(ETH_InitTypeDef* ETH_InitStruct, uint16_t PHYAddress)
{
  ...
  RegValue = ETH_ReadPHYRegister(PHYAddress, 0x00);
  RegValue = ETH_ReadPHYRegister(PHYAddress, 0x01);
  RegValue = ETH_ReadPHYRegister(PHYAddress, 0x02);
  RegValue = ETH_ReadPHYRegister(PHYAddress, 0x03);
